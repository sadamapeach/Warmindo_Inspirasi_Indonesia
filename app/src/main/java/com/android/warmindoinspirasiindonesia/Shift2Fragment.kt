...
class Shift2Fragment : Fragment(), View.OnClickListener{
    ...
    private val selectedShift: String = "2"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnOpenDatePicker = view.findViewById(R.id.btnOpenDatePicker2)
    ...
    override fun onClick(view: View?) {
        if (view != null) {
            if (view.id == R.id.btnOpenDatePicker2) {
                showDatePicker()
            }
        }
    }
